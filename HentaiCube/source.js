...
const DOMAIN = 'https://cbhentai.xyz/';
const method = 'GET';
...
class HentaiCube extends paperback_extensions_common_1.Source {
    ...
    getHomePageSections(sectionCallback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            url = '';
            request = createRequestObject({
                url: 'https://cbhentai.xyz/?s&post_type=wp-manga&m_orderby=latest',
                method: "GET",
            });
            let newUpdatedItems = [];
            data = yield this.requestManager.schedule(request, 1);
            ...
            url = DOMAIN;
            request = createRequestObject({
                url: 'https://cbhentai.xyz/?s&post_type=wp-manga&m_orderby=views',
                method: "GET",
            });
            let newAddItems = [];
            data = yield this.requestManager.schedule(request, 1);
            ...
            url = '';
            request = createRequestObject({
                url: 'https://cbhentai.xyz/?s&post_type=wp-manga&m_orderby=new-manga',
                method: "GET",
            });
            let newItems = [];
            data = yield this.requestManager.schedule(request, 1);
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (homepageSectionId) {
                case "new":
                    url = `https://cbhentai.xyz/page/${page}/?s&post_type=wp-manga&m_orderby=new-manga`;
                    url2 = `https://cbhentai.xyz/page/${page + 1}/?s&post_type=wp-manga&m_orderby=new-manga`;
                    select = 0;
                    break;
                case "new_updated":
                    url = `https://cbhentai.xyz/page/${page}/?s&post_type=wp-manga&m_orderby=latest`;
                    url2 = `https://cbhentai.xyz/page/${page + 1}/?s&post_type=wp-manga&m_orderby=latest`;
                    select = 1;
                    break;
                case "view":
                    url = `https://cbhentai.xyz/page/${page}/?s&post_type=wp-manga&m_orderby=views`;
                    url2 = `https://cbhentai.xyz/page/${page + 1}/?s&post_type=wp-manga&m_orderby=views`;
                    select = 2;
                    break;
                default:
    ...
    getSearchResults(query, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (year.length !== 0) { //year + sort
                if (tags[0].split('.')[0] === 'year' || tags[0].split('.')[0] === 'sort') {
                    if (year.length !== 0 && sort.length !== 0) {
                        ...
                        if (tags[0].split('.')[0] === 'year') {
                            ...
                            set = 1;
                            url = encodeURI(`https://cbhentai.xyz/page/${page}/?s&post_type=wp-manga&${sort[0]}`);
                        }
                    }
                }
            }
                ...
                set = 1;
                url = encodeURI(`https://cbhentai.xyz/page/${page}/?s=${(_d = query.title) !== null && _d !== void 0 ? _d : ""}&post_type=wp-manga&${convertGenres(genre)}&op=&author=&artist=&release=&adult=&${convertStatus(status)}&${sort[0]}`);
            }
            const request = createRequestObject({
                url,
                method: "GET"
    ...
    getSearchTags() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags4 = [];
            const counts = [];
            let url = `https://cbhentai.xyz/?s=&post_type=wp-manga`;
            let request = createRequestObject({
                url: url,
                method: "GET",
            });
            ...
            let $ = this.cheerio.load(response.data);
            let url2 = `https://cbhentai.xyz/manga/`;
